 ...
 * @LastEditTime: 2023-02-27 15:59:26
    ...
    <div class="container">
      <div class="user-layout-content">
        <div class="header">
          ...
          <div class="dec">Ant Design is the most influential web design specification in Xihu district</div>
        </div>
        <router-view />
        <div class="footer">
          <div class="top-text">
...
export default {
  ...
  methods: {
    ...
    //   console.log(222,objA);

    //   console.log(333,objB);
    // },
  },
  created() {
    // this.consoleMethod()
